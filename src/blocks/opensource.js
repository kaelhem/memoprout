...
const Opensource = () => (
  <Fragment>
    ...
    <p>L'intégralité des sources (schèma électronique, fichiers d'impression 3D, code source et données) sont disponibles sur le <a href="https://github.com/kaelhem/memoprout">dépôt github du projet</a></p>
  </Fragment>
)
