...
const data = [
  ...
  {question: `Comment puis-je fabriquer mon propre MemoProut Pad ?`, answer: <span>Vous trouverez l'ensemble des sources sur notre <a href="https://github.com/kaelhem/memoprout/tree/master/make" target="_blank" rel="noopener noreferrer">dépôt GitHub</a>. La documention est toutefois en cours de réalisation. N'hésitez pas à utiliser le formulaire de contact un peu plus bas pour en savoir plus !</span>},
  ...
  {question: `J'ai perdu la notice de mon MemoProut Pad !`, answer: <span>Pas de panique ! La notice est téléchargeable au format PDF <a href="https://github.com/kaelhem/memoprout/blob/master/resources/user-guide.pdf" target="_blank" rel="noopener noreferrer">ici</a>. Vous pouvez l'imprimer en recto-verso.</span> },
